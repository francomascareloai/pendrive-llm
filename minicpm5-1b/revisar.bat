@echo off
chcp 65001 >nul
title Revisar codigo C com MiniCPM5-1B
cd /d "%~dp0"

REM --- revisar.bat: arraste um .c em cima (ou rode: revisar.bat programa.c) ---
REM Requer run-minicpm.bat rodando (servidor na porta 8138)
...
REM so passa -Salvar se foi pedido (string vazia quebraria o switch param)
if defined SALVAR (
